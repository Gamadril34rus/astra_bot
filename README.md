...
Целевой universe содержит около **35 ликвидных USDT-пар**. Перед торговым циклом список сверяется с актуальными перпетуал-контрактами BingX (USDT-M). Бот торгует ТОЛЬКО бессрочными фьючерсами — спотового контура нет.
