...
Результаты на доступных данных:

| Символ | Окно | TSM45 L/S: PF / дох% / DD% | TSM45+ADX: PF / дох% / DD% | История L/S: PF / дох% / DD% |
|---|---|---|---|---|
| BTCUSDT | 2024-08 → 2026-08 | 1.74 / +6.6 / 6 | 1.53 / +4.8 / 5 | 1.42 / +14.3 / 8 |
| ETHUSDT* | 2016-03 → 2021-03 | **2.14 / +72.9 / 18** | **2.05 / +67.1 / 19** | 2.14 / +72.9 / 18 |

\* ETHUSDT_4h.csv в data/ — Bitfinex ETH/USD 1m (2016–2021), агрегированный
в 4h; источник: github.com/Vitaly007/Bitfinex-historical-data-AND-CryptoCompare-historical-data.

**Главный вывод мульти-актива:** правило, откалиброванное на BTC
2024–2026, **вне выборки** (другой актив, другой период 2016–2021)
даёт PF 2.14 на ETH с просадкой 18% — подтверждение, что это не
переобучение под один актив/режим, а устойчивое свойство медленного
трендового импульса. Ранние годы ETH — чистейшая вневыборочная
территория: ни один параметр не видел этих данных.

Для свежих данных ETH/SOL (2021–2026) выгрузите у себя:
...
# после этого:
python scripts/strategy_lab.py   # мульти-актив секция пересчитается автоматически
```
