...
async def test_fair_value_gap_bullish():
    strategy = FairValueGapStrategy(FairValueGapConfig(min_gap_pct=0.002, ema_period=10))
    candles = []
    base_ts = 1000000
    ...
    candles.append(make_candle(108, 108, 102.5, 105, timestamp_ms=base_ts + 23 * 3600000))
