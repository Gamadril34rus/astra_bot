...
from ..core.state import get_system_state, TradingState
from ..core.utils import round_to_precision, round_to_step, safe_decimal
...
class ExecutionConfig:
    ...
    min_fill_quantity: Optional[Decimal] = None
